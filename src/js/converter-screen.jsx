...
const ConverterScreen = (props) => {
	const {history, currencyList} = props;
		...
		<div className="converter-page">
			<header className="header">
				<Link className="logo" to={Routes.MAIN}>
					...
					<span className="logo__title">ЛИГА Банк</span>
				</Link>
				<nav className="nav header__nav">
					<ul className="nav-list header__nav-list">
						<li className="nav-list__item-wrapper">
							<Link className="nav-list__item-link" to={Routes.MAIN}>Услуги</Link>
						</li>
						<li className="nav-list__item-wrapper">
							<Link className="nav-list__item-link" to={Routes.CREDIT}>Рассчитать кредит</Link>
						</li>
						<li className="nav-list__item-wrapper">
							<Link className="nav-list__item-link nav-list__item-link--active" to={Routes.CONVERTER}>Конвертер валют</Link>
						</li>
						<li className="nav-list__item-wrapper">
							<Link className="nav-list__item-link" to={Routes.CONTACTS}>Контакты</Link>
						</li>
						<li className="nav-list__item-wrapper">
							<Link className="nav-list__item-link" to={Routes.QUESTIONS}>Задать вопрос</Link>
						</li>
					</ul>
				</nav>
				<a className="auth" href="">Войти в Интернет-банк</a>
			</header>
			<main  className="index converter-page__index">
				<section className="credit">
					<div className="credit__wrapper">
						<div className="credit__inner">
							<p className="credit__title">Лига Банк</p>
							<p className="credit__desc">Кредиты на любой случай</p>
							<Link className="credit__btn" to="/credit">Рассчитать кредит</Link>
						</div>
					</div>
				</section>
				<Converter history={history} currencyList={currencyList}/>
			</main>
			<footer className="footer">
				<div className="footer__inner">
					<div className="creator">
						...
						<p className="creator__desc">150015, г. Москва, ул. Московская, д. 32
					...
					<div className="contacts contacts--short">
						<span className="contacts__number">*0904</span>
						<p className="contacts__desc">Бесплатно для абонентов МТС, Билайн, Мегафон, Теле2</p>
					</div>
					<div className="contacts contacts--long">
						<span className="contacts__number">8 800 111 22 33</span>
						<p className="contacts__desc">Бесплатный для всех городов России</p>
					</div>
					<ul className="social">
						<a href="" className="social__icon">
							<span className="visually-hidden">Страница в Facebook</span>
						...
						<a href="" className="social__icon">
							<span className="visually-hidden">Страница в Instagram</span>
						...
						<a href="" className="social__icon">
							<span className="visually-hidden">Страница в Twitter</span>
						...
						<a href="" className="social__icon">
							<span className="visually-hidden">Страница в Youtube</span>
							<svg width="16" height="13" viewBox="0 0 16 13" fill="none" xmlns="http://www.w3.org/2000/svg">
